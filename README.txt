...
1) production uses docker containers (running linux debian os) and 2) web servers are aws/azure
cloud environments.
...
(WINDOWS)
Steps: 1) install anaconda, 2) install redis and mongodb, 3) execute py_env_setup_win.bat, 4) execute stack_setup.ps1,
